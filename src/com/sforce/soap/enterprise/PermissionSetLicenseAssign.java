    ...
    extends SObject
{
    ...
    @XmlElement(name = "PermissionSetLicense", nillable = true)
    protected PermissionSetLicense permissionSetLicense;
    @XmlElement(name = "PermissionSetLicenseId", nillable = true)
    protected String permissionSetLicenseId;
     ...
     * @return
     *     possible object is
     *     {@link PermissionSetLicense }
     *     
     */
    public PermissionSetLicense getPermissionSetLicense() {
     ...
     *     
     */
    public void setPermissionSetLicense(PermissionSetLicense value) {
     ...
     *     
     */
    public void setPermissionSetLicenseId(String value) {
