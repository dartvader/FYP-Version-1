...
/**
 * <p>Java class for SecureAgent complex type.
 * 
 ...
 *         &lt;element name="ProxyUser" type="{urn:sobject.enterprise.soap.sforce.com}User" minOccurs="0"/>
 *         &lt;element name="ProxyUserId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
 *         &lt;element name="SecureAgentPlugins" type="{urn:enterprise.soap.sforce.com}QueryResult" minOccurs="0"/>
...
@XmlType(name = "SecureAgent", propOrder = {
    "agentKey",
    "createdBy",
    "createdById",
    "createdDate",
    ...
    extends SObject
{
    ...
    @XmlElement(name = "AgentKey", nillable = true)
    ...
    @XmlElement(name = "ProxyUser", nillable = true)
    protected User proxyUser;
    @XmlElement(name = "ProxyUserId", nillable = true)
    protected String proxyUserId;
    @XmlElement(name = "SecureAgentPlugins", nillable = true)
    protected QueryResultType secureAgentPlugins;
     ...
     *     
     */
    public void setProxyUser(User value) {
    ...
    /**
     * Gets the value of the secureAgentPlugins property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public QueryResultType getSecureAgentPlugins() {
        return secureAgentPlugins;
    }

    /**
     * Sets the value of the secureAgentPlugins property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryResultType }
     *     
     */
    public void setSecureAgentPlugins(QueryResultType value) {
        this.secureAgentPlugins = value;
    }
