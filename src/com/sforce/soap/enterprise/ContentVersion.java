    ...
    extends SObject
{
    ...
    protected Name firstPublishLocation;
    ...
    @XmlElement(name = "IsMajorVersion", nillable = true)
     ...
     *     
     */
    public Name getFirstPublishLocation() {
     ...
     *     
     */
    public void setFirstPublishLocation(Name value) {
