    ...
    extends SObject
{
    ...
    @XmlElement(name = "IsAvailableInTouch", nillable = true)
    protected Boolean isAvailableInTouch;
    @XmlElement(name = "IsConfirmationTokenRequired", nillable = true)
     ...
     *     
     */
    public Boolean isIsConfirmationTokenRequired() {
     ...
     *     
     */
    public void setIsConfirmationTokenRequired(Boolean value) {
