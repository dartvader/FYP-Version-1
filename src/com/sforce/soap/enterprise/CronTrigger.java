    ...
    extends SObject
{
    ...
    @XmlElement(name = "CronJobDetail", nillable = true)
    protected CronJobDetail cronJobDetail;
    @XmlElement(name = "CronJobDetailId", nillable = true)
    protected String cronJobDetailId;
     ...
     *     
     */
    public CronJobDetail getCronJobDetail() {
     ...
     *     
     */
    public void setCronJobDetail(CronJobDetail value) {
     ...
     *     
     */
    public void setCronJobDetailId(String value) {
